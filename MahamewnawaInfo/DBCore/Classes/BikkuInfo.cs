    ...
    public class BikkuInfo : DBBase, IDBFunctions
    {
        ...
        public int Add(bool duplicateNumber)
        {
            ...
            if (AsapuHistry != null)
            {
                ...
                {
                    AddAsapuHistry(his.AsapuID, his.FromDate, his.ToDate, his.Post, his.Note);
                }
            }
        ...
        //Asapu histry
        public void AddAsapuHistry(int asapuID, DateTime fromDate, DateTime toDate, BhikkuPost _post, string note)
        {
