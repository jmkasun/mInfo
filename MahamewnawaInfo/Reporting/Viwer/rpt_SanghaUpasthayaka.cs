...
{
    public partial class rpt_SanghaUpasthayaka : DevComponents.DotNetBar.Office2007Form
    {
        public rpt_SanghaUpasthayaka()
        {
            InitializeComponent();
        }
        ...
        private void rptNameIDReport_Load(object sender, EventArgs e)
        {
            ...
            using (BikkuInfo b = new BikkuInfo(true))
            {
                ...
                AddData(b.SelectAllSanghaUpasthayaka());
        ...
        public void AddData(List<BikkuInfo> data)
        {
            ...
            {
                mahamevnainfoDataSet.BhikkuReportNameID.Rows.Add(b.NameAssumedAtRobing, b.UpasampadaNumber, "", "","", "", "");
            }
        }
    }
}
